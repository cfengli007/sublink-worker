...
export const translations = {
  'zh-CN': {
    ...
    customCountryGrouping: '自定义国家分组',
    selectCountries: '选择国家',
    selectAll: '全选',
    deselectAll: '取消全选',
    moreCountries: '更多国家',
    filterInfoNodes: '过滤信息节点',
    infoKeywordsPlaceholder: '例如：流量,到期,官网',
    infoKeywordsHint: '用逗号分隔多个关键词',
  ...
  'en-US': {
    ...
    customCountryGrouping: 'Custom Country Grouping',
    selectCountries: 'Select Countries',
    selectAll: 'Select All',
    deselectAll: 'Deselect All',
    moreCountries: 'More Countries',
    filterInfoNodes: 'Filter Info Nodes',
    infoKeywordsPlaceholder: 'e.g.: traffic,expire,website',
    infoKeywordsHint: 'Separate keywords with commas',
